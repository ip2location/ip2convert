...
```bash
curl -LO https://github.com/ip2location/ip2convert/releases/download/v1.2.3/ip2convert-1.2.3.deb
sudo dpkg -i ip2convert-1.2.3.deb
```
...
curl -LO https://github.com/ip2location/ip2convert/releases/download/v1.2.3/ip2convert_1.2.3_${PLAT}.tar.gz
# OR
wget https://github.com/ip2location/ip2convert/releases/download/v1.2.3/ip2convert_1.2.3_${PLAT}.tar.gz

tar -xvf ip2convert_1.2.3_${PLAT}.tar.gz
mv ip2convert_1.2.3_${PLAT} /usr/local/bin/ip2convert
```
